...
import { SousmenuComponent } from 'app/entities/sousmenu/sousmenu.component';
...
describe('Component Tests', () => {
    describe('Sousmenu Management Component', () => {
        let comp: SousmenuComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SousmenuComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.sousmenus[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
