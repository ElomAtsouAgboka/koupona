...
import { QuartierComponent } from 'app/entities/quartier/quartier.component';
...
describe('Component Tests', () => {
    describe('Quartier Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.quartiers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
