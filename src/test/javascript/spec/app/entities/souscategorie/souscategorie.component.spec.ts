...
import { SouscategorieComponent } from 'app/entities/souscategorie/souscategorie.component';
...
describe('Component Tests', () => {
    describe('Souscategorie Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.souscategories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
